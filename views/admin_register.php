<?php
// Đăng ký admin với Bootstrap styling
?>
<!DOCTYPE html>
<html lang="vi">
...
<head>
    ...
    <title>Đăng ký Admin - Tour Du Lịch</title>
...
<body>
    <div class="register-container">
        <div class="register-card">
            ...
            <p class="subtitle">Tạo tài khoản quản trị mới</p>
            ...
            <form method="post" action="index.php?act=admin_register">
                <div class="mb-3">
                    <label for="name" class="form-label">Họ tên</label>
                    <input type="text" class="form-control" id="name" name="name" placeholder="Nhập họ tên" value="<?php echo htmlspecialchars($_POST['name'] ?? ''); ?>" required>
                </div>
            ...
            <div class="link-section">
                <p class="mb-0">Đã có tài khoản? <a href="index.php?act=admin_login">Đăng nhập</a></p>
            </div>
        </div>
    </div>
